        ...
        namespace externalBeam
        {
            namespace density
            {
                ...
                struct ProbingBeamImpl : public T_ParamClass
                {
                    ...
                    static constexpr bool limitInY = ParamClass::limitInY;
                    static constexpr float_32 minY = ParamClass::minY_SI / UNIT_LENGTH;
                    static constexpr float_32 maxY = ParamClass::maxY_SI / UNIT_LENGTH;
                    ...
                    HINLINE ProbingBeamImpl(uint32_t currentStep) : probingBeam_m(), currentStep_m(currentStep)
                    {
                    }
