            ...
            namespace generic
            {
                namespace acc
                {
                    ...
                    struct FreeRng : private T_Functor
                    {
                        ...
                        HDINLINE auto operator()(T_Acc const&, T_Particle& particle, T_Args&&... args)
                        {
                            return Functor::operator()(m_rng, particle, args...);
                        }
                    ...
                    , private picongpu::particles::functor::misc::Rng<T_Distribution>
                {
                    ...
                    using AccFunctorType = acc::FreeRng<Functor, RngType>;
