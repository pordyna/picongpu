        ...
        namespace scattering
        {
            namespace condition
            {
                namespace acc
                {
                    ...
                    {
                        static constexpr float_X totalCrossSection
                            = static_cast<float_X>(T_ParamClass::totalCrossSection_SI / UNIT_LENGTH / UNIT_LENGTH);
                        ...
                        DINLINE bool operator()(T_rng& rng, T_Particle const& particle, float_X const& density) const
                        {
                            ...
                            const float_X probability{
                                DELTA_T * SPEED_OF_LIGHT * totalCrossSection * density
