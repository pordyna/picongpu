            ...
            namespace condition
            {
                namespace acc
                {
                    ...
                    struct Threshold
                    {
                        ...
                        static constexpr float_X threshold
                            = ParamClass::threshold * UNIT_LENGTH * UNIT_LENGTH * UNIT_LENGTH;
                        ...
                        DINLINE bool operator()(T_Particle const& particle, float_X const& density) const
                        {
                            if(!CheckMax::check(particle))
                                return false;
                            return (density * particles::TYPICAL_NUM_PARTICLES_PER_MACROPARTICLE > threshold);
                        }
                    };
                } // namespace acc
            } // namespace condition
